...
const config = {
  ...
  jwt_email_verification_secret_expires_in: process.env.JWT_EMAIL_VERIFICATION_SECRET_EXPIRES_IN as ExpiresIn,
  ...
  google_cloud_storage_bucket: process.env.GOOGLE_CLOUD_STORAGE_BUCKET as string,
  ...
  stripe_webhook_secret_key_test: process.env.STRIPE_WEBHOOK_SECRET_KEY_TEST as string,
